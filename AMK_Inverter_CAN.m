function msg = AMK_Inverter_CAN(msgname,type)
  if(255==type)
  msg = struct;
  msg.num=12;
...
case 'VCU4_0x189'
    ...
    ECOCAN.VCU4_0x189.fields{1}.scale = 0.1;
    ...
    ECOCAN.VCU4_0x189.fields{2}.name = 'VCU__DcOn';
    ...
    ECOCAN.VCU4_0x189.fields{6}.name = 'VCU_TargetVelocity';
    ECOCAN.VCU4_0x189.fields{6}.units = 'rpm';
    ...
    ECOCAN.VCU4_0x189.fields{7}.scale = 0.1;
...
case 'VCU3_0x188'
    ...
    ECOCAN.VCU3_0x188.fields{1}.scale = 0.1;
    ...
    ECOCAN.VCU3_0x188.fields{2}.name = 'VCU__DcOn';
    ...
    ECOCAN.VCU3_0x188.fields{6}.name = 'VCU_TargetVelocity';
    ECOCAN.VCU3_0x188.fields{6}.units = 'rpm';
    ...
    ECOCAN.VCU3_0x188.fields{7}.scale = 0.1;
...
case 'VCU2_0x185'
    ...
    ECOCAN.VCU2_0x185.fields{1}.scale = 0.1;
    ...
    ECOCAN.VCU2_0x185.fields{2}.name = 'VCU__DcOn';
    ...
    ECOCAN.VCU2_0x185.fields{6}.name = 'VCU_TargetVelocity';
    ECOCAN.VCU2_0x185.fields{6}.units = 'rpm';
    ...
    ECOCAN.VCU2_0x185.fields{7}.scale = 0.1;
...
%%
%Network Node:Vector__XXX
%Message Name:MCU4_290
%Message Number:4
case 'MCU4_290'
    ECOCAN.MCU4_290 = struct;
    ECOCAN.MCU4_290.name = 'MCU4_290';
    ECOCAN.MCU4_290.description = 'MCU4_290';
    ECOCAN.MCU4_290.protocol  = 'ECOCAN';
    ECOCAN.MCU4_290.id = hex2dec('290');
    ECOCAN.MCU4_290.idext = 'STANDARD';
    ECOCAN.MCU4_290.payload_size =8;
    ECOCAN.MCU4_290.interval =100;

    ECOCAN.MCU4_290.fields{1}.name = 'MCU_ErrorInfo';
    ECOCAN.MCU4_290.fields{1}.units = '';
    ECOCAN.MCU4_290.fields{1}.start_bit = 32;
    ECOCAN.MCU4_290.fields{1}.bit_length = 16;
    ECOCAN.MCU4_290.fields{1}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.MCU4_290.fields{1}.data_type = 'UNSIGNED';
    ECOCAN.MCU4_290.fields{1}.scale = 1;
    ECOCAN.MCU4_290.fields{1}.offset = 0;
    ECOCAN.MCU4_290.fields{1}.multiplex_type = 'Standard';
    ECOCAN.MCU4_290.fields{1}.multiplex_value = 0;

    ECOCAN.MCU4_290.fields{2}.name = 'MCU_TempIGBT';
    ECOCAN.MCU4_290.fields{2}.units = '¡æ';
    ECOCAN.MCU4_290.fields{2}.start_bit = 48;
    ECOCAN.MCU4_290.fields{2}.bit_length = 16;
    ECOCAN.MCU4_290.fields{2}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.MCU4_290.fields{2}.data_type = 'UNSIGNED';
    ECOCAN.MCU4_290.fields{2}.scale = 0.1;
    ECOCAN.MCU4_290.fields{2}.offset = 0;
    ECOCAN.MCU4_290.fields{2}.multiplex_type = 'Standard';
    ECOCAN.MCU4_290.fields{2}.multiplex_value = 0;

    ECOCAN.MCU4_290.fields{3}.name = 'MCU_TempInverter';
    ECOCAN.MCU4_290.fields{3}.units = '¡æ';
    ECOCAN.MCU4_290.fields{3}.start_bit = 16;
    ECOCAN.MCU4_290.fields{3}.bit_length = 16;
    ECOCAN.MCU4_290.fields{3}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.MCU4_290.fields{3}.data_type = 'UNSIGNED';
    ECOCAN.MCU4_290.fields{3}.scale = 0.1;
    ECOCAN.MCU4_290.fields{3}.offset = 0;
    ECOCAN.MCU4_290.fields{3}.multiplex_type = 'Standard';
    ECOCAN.MCU4_290.fields{3}.multiplex_value = 0;

    ECOCAN.MCU4_290.fields{4}.name = 'MCU_TempMotor';
    ECOCAN.MCU4_290.fields{4}.units = '¡æ';
    ECOCAN.MCU4_290.fields{4}.start_bit = 0;
    ECOCAN.MCU4_290.fields{4}.bit_length = 16;
    ECOCAN.MCU4_290.fields{4}.byte_order = 'LITTLE_ENDIAN';
    ECOCAN.MCU4_290.fields{4}.data_type = 'UNSIGNED';
    ECOCAN.MCU4_290.fields{4}.scale = 0.1;
    ECOCAN.MCU4_290.fields{4}.offset = 0;
    ECOCAN.MCU4_290.fields{4}.multiplex_type = 'Standard';
    ECOCAN.MCU4_290.fields{4}.multiplex_value = 0;
...
case 'MCU4_288'
    ...
    ECOCAN.MCU4_288.fields{2}.name = 'MCU_ManetizingCurrent';
    ECOCAN.MCU4_288.fields{2}.units = 'Arms';
    ...
    ECOCAN.MCU4_288.fields{2}.scale = 1.220703E-03;
    ...
    ECOCAN.MCU4_288.fields{5}.name = 'MCU__QuitInverterOn';
    ...
    ECOCAN.MCU4_288.fields{9}.name = 'MCU__SystemReady';
...
case 'MCU3_287'
    ...
    ECOCAN.MCU3_287.fields{2}.name = 'MCU_ManetizingCurrent';
    ECOCAN.MCU3_287.fields{2}.units = 'Arms';
    ...
    ECOCAN.MCU3_287.fields{2}.scale = 1.220703E-03;
    ...
    ECOCAN.MCU3_287.fields{5}.name = 'MCU__QuitInverterOn';
    ...
    ECOCAN.MCU3_287.fields{9}.name = 'MCU__SystemReady';
...
case 'MCU2_284'
    ...
    ECOCAN.MCU2_284.fields{2}.name = 'MCU_ManetizingCurrent';
    ECOCAN.MCU2_284.fields{2}.units = 'Arms';
    ...
    ECOCAN.MCU2_284.fields{2}.scale = 1.220703E-03;
    ...
    ECOCAN.MCU2_284.fields{5}.name = 'MCU__QuitInverterOn';
    ...
    ECOCAN.MCU2_284.fields{9}.name = 'MCU__SystemReady';
...
case 'VCU1_0x184'
    ...
    ECOCAN.VCU1_0x184.fields{1}.scale = 0.1;
    ...
    ECOCAN.VCU1_0x184.fields{2}.name = 'VCU__DcOn';
    ...
    ECOCAN.VCU1_0x184.fields{6}.name = 'VCU_TargetVelocity';
    ECOCAN.VCU1_0x184.fields{6}.units = 'rpm';
    ...
    ECOCAN.VCU1_0x184.fields{7}.scale = 0.1;
...
case 'MCU1_283'
    ...
    ECOCAN.MCU1_283.fields{2}.name = 'MCU_ManetizingCurrent';
    ECOCAN.MCU1_283.fields{2}.units = 'Arms';
    ...
    ECOCAN.MCU1_283.fields{2}.scale = 1.220703E-03;
    ...
    ECOCAN.MCU1_283.fields{5}.name = 'MCU__QuitInverterOn';
    ...
    ECOCAN.MCU1_283.fields{9}.name = 'MCU__SystemReady';
