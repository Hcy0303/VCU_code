function msg = BCU_HCU_INFO_v3(msgname,type)
  if(255==type)
  msg = struct;
  msg.num=3;
...
case 'BMS_HCU_MAXT'
    ...
    ECOCAN.BMS_HCU_MAXT.payload_size =8;
    ECOCAN.BMS_HCU_MAXT.interval =-1;

    ECOCAN.BMS_HCU_MAXT.fields{1}.name = 'Unused_1';
    ECOCAN.BMS_HCU_MAXT.fields{1}.units = '';
    ECOCAN.BMS_HCU_MAXT.fields{1}.start_bit = 56;
    ECOCAN.BMS_HCU_MAXT.fields{1}.bit_length = 16;
    ...
    ECOCAN.BMS_HCU_MAXT.fields{2}.name = 'Heating_Ctl';
    ECOCAN.BMS_HCU_MAXT.fields{2}.units = '';
    ECOCAN.BMS_HCU_MAXT.fields{2}.start_bit = 40;
    ...
    ECOCAN.BMS_HCU_MAXT.fields{3}.name = 'Cooling_Ctl';
    ECOCAN.BMS_HCU_MAXT.fields{3}.units = '';
    ECOCAN.BMS_HCU_MAXT.fields{3}.start_bit = 32;
    ...
    ECOCAN.BMS_HCU_MAXT.fields{4}.offset = 0;
    ECOCAN.BMS_HCU_MAXT.fields{4}.multiplex_type = 'Standard';
    ECOCAN.BMS_HCU_MAXT.fields{4}.multiplex_value = 0;

    ECOCAN.BMS_HCU_MAXT.fields{5}.name = 'MaxTempNo';
    ECOCAN.BMS_HCU_MAXT.fields{5}.units = '';
    ECOCAN.BMS_HCU_MAXT.fields{5}.start_bit = 16;
    ECOCAN.BMS_HCU_MAXT.fields{5}.bit_length = 8;
    ECOCAN.BMS_HCU_MAXT.fields{5}.byte_order = 'BIG_ENDIAN';
    ECOCAN.BMS_HCU_MAXT.fields{5}.data_type = 'UNSIGNED';
    ECOCAN.BMS_HCU_MAXT.fields{5}.scale = 1;
    ECOCAN.BMS_HCU_MAXT.fields{5}.offset = 0;
    ECOCAN.BMS_HCU_MAXT.fields{5}.multiplex_type = 'Standard';
    ECOCAN.BMS_HCU_MAXT.fields{5}.multiplex_value = 0;

    ECOCAN.BMS_HCU_MAXT.fields{6}.name = 'MinTemp';
    ECOCAN.BMS_HCU_MAXT.fields{6}.units = '';
    ECOCAN.BMS_HCU_MAXT.fields{6}.start_bit = 8;
    ECOCAN.BMS_HCU_MAXT.fields{6}.bit_length = 8;
    ECOCAN.BMS_HCU_MAXT.fields{6}.byte_order = 'BIG_ENDIAN';
    ECOCAN.BMS_HCU_MAXT.fields{6}.data_type = 'UNSIGNED';
    ECOCAN.BMS_HCU_MAXT.fields{6}.scale = 1;
    ECOCAN.BMS_HCU_MAXT.fields{6}.offset = -40;
    ECOCAN.BMS_HCU_MAXT.fields{6}.multiplex_type = 'Standard';
    ECOCAN.BMS_HCU_MAXT.fields{6}.multiplex_value = 0;

    ECOCAN.BMS_HCU_MAXT.fields{7}.name = 'MaxTemp';
    ECOCAN.BMS_HCU_MAXT.fields{7}.units = '';
    ECOCAN.BMS_HCU_MAXT.fields{7}.start_bit = 0;
    ECOCAN.BMS_HCU_MAXT.fields{7}.bit_length = 8;
    ECOCAN.BMS_HCU_MAXT.fields{7}.byte_order = 'BIG_ENDIAN';
    ECOCAN.BMS_HCU_MAXT.fields{7}.data_type = 'UNSIGNED';
    ECOCAN.BMS_HCU_MAXT.fields{7}.scale = 1;
    ECOCAN.BMS_HCU_MAXT.fields{7}.offset = -40;
    ECOCAN.BMS_HCU_MAXT.fields{7}.multiplex_type = 'Standard';
    ECOCAN.BMS_HCU_MAXT.fields{7}.multiplex_value = 0;
...
case 'BMS_HCU_MAXV'
    ...
    ECOCAN.BMS_HCU_MAXV.payload_size =8;
    ECOCAN.BMS_HCU_MAXV.interval =-1;

    ECOCAN.BMS_HCU_MAXV.fields{1}.name = 'Unused_2';
    ECOCAN.BMS_HCU_MAXV.fields{1}.units = '';
    ECOCAN.BMS_HCU_MAXV.fields{1}.start_bit = 56;
    ECOCAN.BMS_HCU_MAXV.fields{1}.bit_length = 16;
    ...
    ECOCAN.BMS_HCU_MAXV.fields{2}.name = 'MinCellVoltNo';
    ECOCAN.BMS_HCU_MAXV.fields{2}.units = '';
    ECOCAN.BMS_HCU_MAXV.fields{2}.start_bit = 40;
    ...
    ECOCAN.BMS_HCU_MAXV.fields{3}.name = 'MaxCellVoltNo';
    ECOCAN.BMS_HCU_MAXV.fields{3}.units = '';
    ECOCAN.BMS_HCU_MAXV.fields{3}.start_bit = 32;
    ECOCAN.BMS_HCU_MAXV.fields{3}.bit_length = 8;
    ...
    ECOCAN.BMS_HCU_MAXV.fields{4}.name = 'MinCellVolt';
    ECOCAN.BMS_HCU_MAXV.fields{4}.units = '';
    ECOCAN.BMS_HCU_MAXV.fields{4}.start_bit = 24;
    ...
    ECOCAN.BMS_HCU_MAXV.fields{5}.name = 'MaxCellVolt';
    ECOCAN.BMS_HCU_MAXV.fields{5}.units = '';
    ECOCAN.BMS_HCU_MAXV.fields{5}.start_bit = 8;
    ECOCAN.BMS_HCU_MAXV.fields{5}.bit_length = 16;
    ECOCAN.BMS_HCU_MAXV.fields{5}.byte_order = 'BIG_ENDIAN';
    ECOCAN.BMS_HCU_MAXV.fields{5}.data_type = 'UNSIGNED';
    ECOCAN.BMS_HCU_MAXV.fields{5}.scale = 1;
    ECOCAN.BMS_HCU_MAXV.fields{5}.offset = 0;
    ECOCAN.BMS_HCU_MAXV.fields{5}.multiplex_type = 'Standard';
    ECOCAN.BMS_HCU_MAXV.fields{5}.multiplex_value = 0;
